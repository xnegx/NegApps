...
public class Header {
	...
	public String getHeader(String arquivo) throws IOException {
		...
		temp.append("Tamanho do cabeçalho: " + header.getTamanhoDoHeader(arquivo) + System.lineSeparator());
		temp.append("Versao do protocolo: " + header.getVersaoProtocolo(arquivo) + System.lineSeparator());
		temp.append("Código de erro: " + header.getCodigoDeErro(arquivo) + System.lineSeparator());
		temp.append("Indicação de tratamento especial: " + header.getTratamentoEspecial(arquivo) + System.lineSeparator());
		temp.append("Reservado para uso futuro: " + header.getUsoFuturo(arquivo) + System.lineSeparator());
		temp.append("Algoritmo da chave assimétrica do destino: " + header.getChaveAssimetricaDestino(arquivo) + System.lineSeparator());
		temp.append("Algoritmo da chave simétrica: " + header.getAlgoritimoChaveSimetrica(arquivo) + System.lineSeparator());
		temp.append("Algoritmo da chave assimétrica local: " + header.getChaveAssimetricaLocal(arquivo) + System.lineSeparator());
		temp.append("Algoritmo de \"hash\": " + header.getHash(arquivo) + System.lineSeparator());
		temp.append("Certificado digital do destino: " + header.getAcCertificadoDestino(arquivo) + System.lineSeparator());
		temp.append("Série do certificado digital do destino: " + header.getNumeroDeSerieDoDestino(arquivo) + System.lineSeparator());
		temp.append("Certificado digital do destinatario: " + header.getAcCertificadoLocal(arquivo) + System.lineSeparator());
		temp.append("Série do certificado digital de origem: " + header.getNumeroDeSerieDoLocal(arquivo) + System.lineSeparator());
